...
public class AnkleExam extends Fragment implements View.OnClickListener {
    ...
    public static AnkleExam newInstance(String param1, String param2) {
        AnkleExam fragment = new AnkleExam();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ankle_exam, container, false);
        view.findViewById(R.id.Save_button).setOnClickListener(this);

        SpinnerUtility.SpinnerCreate(this,view,info,R.id.spinner_ankleOedema,R.array.YesNoExamString,"Ankle Oedema");
