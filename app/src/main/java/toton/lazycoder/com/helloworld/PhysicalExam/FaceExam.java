...
public class FaceExam extends Fragment implements View.OnClickListener{
    ...
    public static FaceExam newInstance(String param1, String param2) {
        FaceExam fragment = new FaceExam();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_face_exam, container, false);
        view.findViewById(R.id.Save_button).setOnClickListener(this);

        SpinnerUtility.SpinnerCreate(this,view,info,R.id.spinner_SwollenFace,R.array.SwollenFace,"Swollen Face");
