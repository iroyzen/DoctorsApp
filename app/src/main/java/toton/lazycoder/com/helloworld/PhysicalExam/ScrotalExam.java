...
public class ScrotalExam extends Fragment implements View.OnClickListener {
    ...
    public static ScrotalExam newInstance(String param1, String param2) {
        ScrotalExam fragment = new ScrotalExam();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_scrotal_exam, container, false);
        view.findViewById(R.id.Save_button).setOnClickListener(this);

        SpinnerUtility.SpinnerCreate(this,view,info,R.id.spinner_ScrotalSwelling,R.array.YesNoExamString,"Scrotal Swelling");
        SpinnerUtility.SpinnerCreate(this,view,info,R.id.spinner_ScrotalRedness,R.array.YesNoExamString,"Scrotal Redness");
